...
class AppUserDAORepositoryTest {
    ...
    public AppUserDAORepositoryTest(AuthorDAO authorDAO, TestEntityManager entityManager) {
        this.testObject = authorDAO;
    ...
    void findById() {
        ...
        // Act
        Author foundAuthor = (Author) testObject.findById(toFind.getAuthorId());
